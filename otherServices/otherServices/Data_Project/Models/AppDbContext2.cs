...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server =ASSEM ; Database =otherServices; Integrated Security = SSPI ; TrustServerCertificate = True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Comment>(entity =>
        {
            ...
            entity.HasOne(d => d.Post).WithMany(p => p.Comments)
                ...
                .HasConstraintName("FK__Comments__Post_I__6E01572D");

            entity.HasOne(d => d.User).WithMany(p => p.Comments)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Comments__user_I__6D0D32F4");
        });
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.HasOne(d => d.Landlord).WithMany(p => p.MessageLandlords)
                .HasForeignKey(d => d.LandlordId)
                .HasConstraintName("FK__messages__date_m__18EBB532");

            entity.HasOne(d => d.Tenant).WithMany(p => p.MessageTenants)
